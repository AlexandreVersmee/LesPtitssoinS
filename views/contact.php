            ...
            <main>
                <div class="row">
                    <div class="small-12 columns">
                        <p>Vous souhaitez prendre rendez-vous ? Vous avez besoin de conseils ?</p>
                        <p>Vous souhaitez obtenir des détails supplémentaires sur les soins que je propose ?<</p>
                        <p>Pour toutes questions, vous pouvez me contact :</p>
                        ...
                        <div class="row">
                            ...
                            <div class="small-4 columns">
                                <a class="icone_email" href="mailto:lesptitssoins@gmail.com">
                                    <i class="fa fa-envelope"></i>
                                    lesptitssoins@gmail.com
                                </a>
                            </div>
                            <div class="small-4 columns">
                                <a href="#">
